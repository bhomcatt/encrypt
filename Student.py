...
firebase = firebase.FirebaseApplication("https://whatsap-8aef4-default-rtdb.firebaseio.com/", None)
...
def enterRoom():
    ...
    message_label = Label(message_window, text="Mensaje " , font = 'arial 13', bg='#AFC1D6', fg="white")
    ...
    btn_send = Button(message_window, text="Enviar", font = 'arial 13', bg="#D6CA98", fg="black", padx=10, relief=FLAT)
    btn_send.place(relx=0.5,rely=0.9, anchor=CENTER)
    
    message_window.mainloop()
    

username_label = Label(login_window, text="Nombre de usuario: " , font = 'arial 13', bg ='#AB92BF', fg="white")
username_label.place(relx=0.2,rely=0.3, anchor=CENTER)

username_entry = Entry(login_window)
username_entry.place(relx=0.6,rely=0.3, anchor=CENTER)

your_code_label = Label(login_window, text="Tu código:  " , font = 'arial 13', bg ='#AB92BF', fg="white")
...
friends_code_label = Label(login_window, text="Código de tu amigo:  " , font = 'arial 13', bg ='#AB92BF', fg="white")
...
btn_start = Button(login_window, text="Iniciar" , font = 'arial 13' , bg="#CEF9F2", fg="black", command=enterRoom, relief=FLAT, padx=10)
